...
Oliver Schonefeld <schonefeld@ids-mannheim.de>; Leif-Jöran Olsson <leif-joran.olsson@svenska.gu.se>; Peter M. Fischer <fisseni@ids-mannheim.de>; Erik Körner <koerner@saw-leipzig.de>
v1.0, 2018-09-06
// more metadata
